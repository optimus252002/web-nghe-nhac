    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{route('admin.doCreate.singer')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="exampleInputUsername1">Name Singer</label>
                        <input type="name" class="form-control" id="exampleInputUsername1" placeholder="Create singer" name="nameSinger">
                    </div>
                    @error('nameSinger')
